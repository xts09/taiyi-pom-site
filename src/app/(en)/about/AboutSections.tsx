        ...
        <div className={`site-container ${styles.heroInner}`}>
          <div className={styles.heroCopy}>
            ...
            <p className={styles.heroSummary}>
              Taiyi Polymer is the international brand of Jiangsu Taiyi Nano Technology Co., Ltd. Since 2003, our Yancheng site has developed and manufactured modified POM alongside selected PA6, PA66 and PPA compounds. Material testing, repeat production and batch documentation are coordinated within the same manufacturing operation.
            </p>
