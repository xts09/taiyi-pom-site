...
type LocalizedConductivePomRouteProps = {
  params: Promise<{ locale: string }>;
};

const sourcePath = "/conductive-antistatic-pom" as const;

const resolveLocale = async (
  params: LocalizedConductivePomRouteProps["params"],
) => {
...
export default async function LocalizedConductivePomRoute({
  params,
