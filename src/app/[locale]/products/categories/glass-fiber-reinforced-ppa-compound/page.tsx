...
type LocalizedPpaGfRouteProps = {
  params: Promise<{ locale: string }>;
};

const sourcePath =
  "/products/categories/glass-fiber-reinforced-ppa-compound" as const;

const resolveLocale = async (
  params: LocalizedPpaGfRouteProps["params"],
) => {
...
export async function generateMetadata({
  params,
}: LocalizedPpaGfRouteProps): Promise<Metadata> {
...
export default async function LocalizedPpaGfRoute({
  params,
}: LocalizedPpaGfRouteProps) {
  const localeConfig = await resolveLocale(params);
