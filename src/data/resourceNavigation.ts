...
export const resourceNavigationGroups: ResourceNavigationGroup[] = [
  {
    ...
    imageAlt:
      "Material Selection technical resources from Taiyi Nano",
    links: [
      {
  ...
  },
  {
    ...
    imageAlt:
      "Processing and Troubleshooting technical resources from Taiyi Nano",
    links: [
      {
  ...
  },
  {
    ...
    imageAlt: "Data and Validation technical resources from Taiyi Nano",
    links: [
      {
