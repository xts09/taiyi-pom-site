...
export type ResourceArticleFeature =
  ...
  | ResourceArticlePartShowcaseFeature;
...
export const resourcePages: ResourcePage[] = [
  {
    ...
    relatedLinks: [
      ...
      {
        label: "Validate an Alternative POM Grade",
  ...
  },
  {
    ...
    intro:
      "Similar TDS values do not make two POM grades interchangeable. Polymer type, flow family, additives, reinforcement, color, and test conditions can differ. So can shrinkage, processing, weld lines, surface quality, wear, and document status. Qualify an alternative for the exact part, mold, process, application, and approval requirements. This guide uses four gates: document review, process and mold trial, molded-part validation, and controlled production release.",
    articleSections: [
      {
    ...
    articleFeatures: [
      {
        ...
        items: [
          {
            title: "Define project equivalence before comparing grades",
            description:
              "Set the incumbent grade, part, mold, process, mandatory criteria, test basis, and approval boundaries before treating any candidate as a possible alternative.",
          },
          {
            title: "A cross-reference is not production approval",
            description:
              "Close document review, the controlled mold trial, molded-part validation, and production controls for the exact grade and color before approval.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    articleFeatures: [
      ...
      },
      {
        ...
        items: [
          {
            title: "Choose the governing contact problem",
            description:
          ...
          {
            title: "Validate the complete contact pair",
            description:
  ...
  },
  {
    ...
    articleSections: [
      ...
      },
      {
        ...
        navLabel: "Gear-Train Validation",
        paragraphs: [
    ...
    articleFeatures: [
      {
        ...
        items: [
          {
            title: "Rank the gear duty and governing failure mode",
            description:
              "Define torque, speed, shock, cycles, temperature, lubrication, alignment, and acceptable backlash before comparing strength, wear, or friction directions.",
          },
          {
            title: "Approve the molded gear train",
            description:
              "Validate traceable gears in the intended shafts, bearings, housing, mating pair, load spectrum, environment, and duty cycle before releasing a grade.",
          },
        ],
      },
      {
      ...
      },
      {
        type: "part-showcase",
        position: "after-section",
        sectionTitle: "Evaluate the Complete Contact Pair",
        title: "Gear geometry changes the material review",
        description:
        ...
        items: [
          {
            ...
            alt: "Compound molded spur gear with a smaller pinion integrated above the main gear",
            label: "Compound spur gear",
          },
          {
            src: "/applications/parts/transparent/motion-worm-gear-v2-transparent.png",
            alt: "Two molded helical gears assembled with metal bearings",
            label: "Helical gear assembly",
          },
          {
            src: "/applications/parts/transparent/automotive-wiper-motor-gear-v2.png",
            alt: "Molded hubbed gear with angled teeth",
            label: "Hubbed gear",
          },
        ],
      },
  ...
  },
  {
    ...
    articleSections: [
      ...
      },
      {
        ...
        navLabel: "Filling / Packing / Cooling",
        paragraphs: [
    ...
    articleFeatures: [
      {
        ...
        items: [
          {
            title: "Measure the shape change before adjusting variables",
            description:
          ...
          {
            title: "Correct the source and verify the process window",
            description:
  ...
  // Include typical parts, operating conditions, failure modes, material concerns, and internal application links.
  {
    ...
    modules: [
      ...
      },
      {
        ...
        navLabel: "Environmental Exposure",
        description:
        ...
        items: [
          {
            title: "Define the performance gap before choosing a fiber",
            description:
              "Measure the missing load, dimensional, electrical, thermal, surface, or wear result before comparing glass fiber, carbon fiber, or a higher fill level.",
          },
          {
            title: "Release the matrix-and-fiber system in the molded part",
            description:
              "Confirm polymer choice, orientation, weld lines, warpage, processing feasibility, function, documents, and repeatability for the exact formulation and color.",
          },
        ],
      },
      {
        type: "part-showcase",
        position: "after-section",
        sectionTitle: "Glass Fiber and Carbon Fiber Solve Different Problems",
        title: "Reinforcement changes the molded part",
        description:
        ...
        items: [
          {
            ...
            alt: "Molded annular bearing cage with evenly spaced pockets",
            label: "Bearing cage geometry",
          },
          {
            src: "/applications/parts/transparent/industrial-coupling-insert-transparent.png",
            alt: "Molded coupling insert with a cross-shaped hub",
            label: "Coupling insert",
          },
          {
            src: "/applications/parts/transparent/industrial-linear-guide-block-transparent.png",
            alt: "Molded linear guide block with mounting holes and a channel",
  ...
  },
  {
    ...
    articleSections: [
      ...
      },
      {
        ...
        navLabel: "Temperature / Load / Toughness",
        paragraphs: [
    ...
    articleFeatures: [
      {
        ...
        items: [
          ...
          {
            title: "Decide from the qualified molded part",
            description:
    ...
    relatedLinks: [
      ...
      {
        label: "Review Moisture, Drying, and Conditioning",
  ...
  },
  {
    ...
    articleSections: [
      ...
      },
      {
        ...
        navLabel: "Orientation & Weld Lines",
        paragraphs: [
    ...
    articleFeatures: [
      {
        ...
        items: [
          {
            title: "Choose the matrix at a matched fiber level",
            description:
          ...
          {
            title: "Raise reinforcement only against a measured gap",
            description:
    ...
    relatedLinks: [
      ...
      { label: "Browse PA66 Compounds", href: "/products/categories/pa66-compound" },
      {
        label: "Review PA6 and PA66 Moisture Control",
        href: "/resources/pa6-pa66-moisture-drying-conditioning-guide",
      },
  ...
  },
  {
    ...
    articleSections: [
      ...
      },
      {
        ...
        navLabel: "Environment & Electrical",
        paragraphs: [
      ...
      },
      {
        ...
        navLabel: "Upgrade Qualification",
        paragraphs: [
    ...
    articleFeatures: [
      {
        ...
        items: [
          {
            title: "Prove the PA66 performance gap first",
            description:
          ...
          {
            title: "Approve PPA only when the measured benefit survives production",
            description:
  ...
  },
  {
    ...
    intro:
      "Moisture has two roles in PA6 and PA66 projects. Too much moisture in granules can disrupt processing and part quality. Controlled absorption after molding changes part dimensions and mechanical state. Drying and conditioning are therefore different operations. This guide separates pellet preparation, inspection, conditioning, storage, and service exposure so each validation state can be repeated.",
    articleSections: [
      {
        title: "Separate Four Moisture States",
        navLabel: "Moisture States",
        paragraphs: [
    ...
    articleFeatures: [
      {
        ...
        items: [
          {
            title: "Separate pellet drying from finished-part conditioning",
            description:
              "Control granule moisture for processing, then define dry-as-molded, conditioned, assembly, and in-service states as separate part requirements.",
          },
          {
            title: "Attach a state and time to every result",
            description:
              "Record the conditioning method, storage, measurement timing, geometry, and service exposure before comparing dimensions, mechanics, electrical behavior, or function.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    intro:
      "A conductive or antistatic polymer specification needs more than a power-of-ten range. Surface, volume, and static-decay measurements are different. Part thickness, electrodes, conditioning, humidity, flow, weld lines, and grounding can change results. Taiyi Polymer lists CNT and carbon-fiber directions for PA6, PA66, and PPA. This guide helps define the requirement, screen the technology, and qualify the finished part.",
    articleSections: [
      {
        title: "Define the Electrical Function and Measurement Basis",
        navLabel: "Electrical Basis",
        paragraphs: [
      ...
      },
      {
        ...
        navLabel: "Electrical Qualification",
        paragraphs: [
    ...
    articleFeatures: [
      {
        ...
        items: [
          {
            title: "Define the electrical function and test basis",
            description:
              "Specify surface, volume, or decay behavior with units, voltage, electrodes, geometry, conditioning, locations, grounding path, and acceptable variation.",
          },
          {
            title: "Qualify the matrix, technology, and grounded part together",
            description:
              "Choose PA6, PA66, or PPA from service needs, then validate CNT or carbon fiber through molding variation, environment, mechanics, and the finished assembly.",
          },
        ],
      },
      {
        type: "part-showcase",
        position: "after-section",
        sectionTitle: "Design the Part, Conductive Network and Ground Together",
        title: "Electrical function follows the complete assembly",
        description:
        ...
        items: [
          {
            ...
            alt: "Molded control-box cover with perimeter fastening features",
            label: "Control-box cover",
          },
          {
            src: "/applications/parts/transparent/electronics-parts-10-transparent.png",
            alt: "Molded rotary electrical component with slotted adjustment rings",
            label: "Rotary electrical part",
          },
          {
            src: "/applications/parts/transparent/automotive-controlbox-components-transparent.png",
            alt: "Molded control-box components with mounting and retention features",
