export const wearTestEvidence = {
  ...
  records: [
    {
      id: "enm1040", grade: "ENM1040", specimen: "ENM1040 7#",
    ...
    {
      id: "eso102", grade: "ESO102", specimen: "ESO102",
    ...
    {
      id: "etm100-nm", grade: "ETM100-NM", specimen: "ETM100-NM",
    ...
    {
      id: "ems102", grade: "EMS102", specimen: "EMS102",
    ...
    {
      id: "eptl402", grade: "EPTL402", specimen: "EPTL402",
    ...
    {
      id: "eps055", grade: "EPS055", specimen: "EPS055",
...
const copy = {
  en: {
    ...
    entryIntro: "Explore six report records by condition, with measured results, process curves and available specimen photos.",
    entryAction: "Open the wear test benchmark",
    benchmarkTitle: "POM wear test benchmark",
    benchmarkIntro: "Explore test results for six POM grades, with load, run time, process curves and before-and-after specimen photos.",
    benchmarkKicker: "TEST EVIDENCE / POM",
    tableTitle: "Test results",
    tableIntro: "Browse by load and speed. Select a grade to see its test record.",
  ...
  zh: {
    ...
    entryIntro: "按工况查看六条报告记录、测量值、过程曲线和现有试样照片。",
    entryAction: "查看耐磨测试 Benchmark",
    benchmarkTitle: "POM 耐磨测试 Benchmark",
    benchmarkIntro: "查看六个 POM 牌号的测试结果、运行工况、过程曲线与试验前后照片。",
    benchmarkKicker: "测试证据 / POM",
    tableTitle: "测试结果",
    tableIntro: "按载荷与转速浏览，点击牌号查看对应试验记录。",
    recordAction: "查看记录",
    detailTitle: "曲线与试样照片",
