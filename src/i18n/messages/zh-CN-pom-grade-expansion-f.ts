...
export const chinesePomGradeExpansionF = {
  "egh25cn-conductive-antistatic-pom": createChinesePomGradeProfile({
    grade: "EGH25CN",
    categoryLabel,
    metadataTitle: "EGH25CN 受控电阻率 POM | Taiyi Polymer",
    metadataDescription:
      "评估 EGH25CN 黑色 POM 的受控电阻率、刚度、收缩与热性能方向，并申请资料或样品。",
    imageAlt: "Taiyi Polymer EGH25CN 黑色导电抗静电 POM 粒子",
  ...
  "ecn1003b-conductive-pom": createChinesePomGradeProfile({
    grade: "ECN1003B",
    categoryLabel,
    metadataTitle: "ECN1003B 黑色导电 POM | Taiyi Polymer",
    metadataDescription:
      "评估 ECN1003B 黑色导电 POM 的较低表面与体积电阻率、尺寸和力学性能方向。",
    imageAlt: "Taiyi Polymer ECN1003B 黑色导电 POM 粒子",
