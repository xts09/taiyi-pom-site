...
const category = {
  metadata: {
    ...
    description:
      "PLATFORM® 基础 POM 树脂覆盖标准至超高流动层级，面向通用、精密、薄壁及填充敏感的注塑零件。",
  ...
  hero: {
    ...
    title: "基础 POM 树脂",
    description:
      "PLATFORM® 基础 POM 树脂从标准流动延伸至超高流动，面向通用、精密、薄壁及填充敏感的注塑零件。各牌号在加工、机械性能与尺寸表现上各有侧重。",
    overviewLabel: "材料概览",
    overview:
  ...
  directory: {
    kicker: "牌号范围",
    title: "基础 POM 牌号",
    body: "系列从均衡性能延伸至超高流动，目录集中呈现牌号定位、关键数据、中文详情与可提供的项目资料。",
    countSuffix: "个已列牌号",
    grade: "牌号",
    keyData: "关键数据",
    route: "下一步",
    ...
    summaries: {
      ...
      "etm1800-base-pom-resin": "用于长流路或填充要求更高零部件的最高流动牌号。",
      ...
      "xt-100-base-pom-resin": "用于精密与通用注塑件的低密度、高抗冲 POM。",
    },
  },
  faq: {
    kicker: "常见问题",
    ...
    items: [
      {
        question: "基础 POM 系列适合哪些零件？",
        answer:
          "系列面向汽车、电气、卫浴和工业领域的通用、精密与薄壁注塑件，包括对填充能力、机械性能或尺寸控制有不同侧重的零部件。",
      },
      {
        question: "基础 POM 覆盖哪些流动层级？",
        answer:
          "牌号范围从标准和中等流动延伸至高流动与超高流动，可分别服务于常规充填、精密成型、薄壁和较长流路等项目。",
      },
      {
        question: "可以申请哪些资料？",
        answer:
  ...
  inquiry: {
    eyebrow: "基础 POM 项目支持",
    title: "从牌号数据走向稳定成型",
    body: "根据零部件功能、模具和加工要求比较基础 POM 候选牌号，并提供技术数据、项目资料与样品，用于材料评估和试模。",
    action: "联系材料团队",
...
const categoryProfiles = {
  "glass-bead-filled-pom-compound": {
    ...
    metadata: {
      ...
      description:
        "PLATFORM® EGB25 采用 25% 玻璃微珠填充，面向关注纵横向成型收缩、尺寸表现与热性能的 POM 注塑零件。",
    ...
    hero: {
      ...
      title: "玻璃微珠填充 POM",
      description:
        "PLATFORM® EGB25 采用 25% 玻璃微珠填充，面向关注纵向与横向成型收缩、尺寸表现及热性能的精密注塑件。牌号页同时列出流动、机械和热性能数据。",
      overviewLabel: "材料概览",
      overview:
        "EGB25 集中呈现成型收缩、机械性能、热性能与加工相关数据；技术文件与样品按项目确认。",
    },
    navigation: {
    ...
    directory: {
      kicker: "牌号数据",
      title: "EGB25 玻璃微珠填充 POM",
      body: "EGB25 牌号页列出纵向与横向成型收缩、机械及热性能数据，并提供技术文件与样品入口。",
      summaries: {
    ...
    faq: {
      ...
      items: [
        {
          question: "EGB25 面向哪些零件？",
          answer:
            "EGB25 面向关注纵横向成型收缩、尺寸表现和热性能的精密注塑件，可用于汽车、电气、卫浴与工业零部件项目。",
        },
        {
          question: "牌号页提供哪些数据？",
          answer:
            "页面提供成型收缩、机械性能、热性能和加工相关数据，便于把材料数据带入零部件与模具验证。",
        },
        {
          question: "可以申请哪些资料？",
          answer:
    ...
    inquiry: {
      eyebrow: "EGB25 项目支持",
      title: "把收缩数据带入实际零件验证",
      body: "根据零部件尺寸、公差、模具和当前材料评估 EGB25，并提供技术数据、文件与样品，用于试模和项目验证。",
  ...
  "glass-fiber-reinforced-pom-compound": {
    ...
    metadata: {
      ...
      description:
        "PLATFORM® 玻璃纤维增强 POM 覆盖 10% 至 30% 玻纤含量，面向刚度、强度与尺寸控制要求更高的注塑零件。",
    ...
    directory: {
      kicker: "牌号范围",
      title: "玻璃纤维增强 POM 牌号",
      body: "系列覆盖 10% 至 30% 玻纤含量，目录集中呈现刚度、强度、冲击、流动与成型收缩等不同性能组合。",
      summaries: {
      ...
      items: [
        {
          question: "这组材料面向哪些零件？",
          answer:
            "主要面向齿轮、支架、壳体及其他对刚度、强度和尺寸控制要求较高的精密或结构型注塑零件。",
        },
        {
          question: "不同牌号有哪些差异？",
          answer:
            "系列覆盖 10% 至 30% 玻纤含量，并在刚度、强度、冲击、流动和成型收缩之间形成不同组合，可查看各牌号详情与已发布数据。",
        },
        {
          question: "可以获得哪些项目支持？",
          answer:
            "可查看牌号数据并申请技术文件和样品；模具、纤维取向与零件验证可结合项目条件讨论。",
        },
      ],
    },
    inquiry: {
      eyebrow: "玻纤增强 POM 项目支持",
      title: "为结构与精密零件建立刚度基础",
      body: "根据零部件载荷、刚度、尺寸和模具要求比较候选牌号，并提供技术数据与样品，用于试模和项目验证。",
  ...
  "high-impact-pom-compound": {
    ...
    metadata: {
      ...
      description:
        "PLATFORM® 高抗冲 POM 面向冲击敏感、装配受力及低温使用的注塑零件，覆盖不同刚韧与加工性能组合。",
    ...
    hero: {
      ...
      title: "高抗冲 POM",
      description:
        "PLATFORM® 高抗冲 POM 面向冲击敏感、装配受力或低温使用的功能零件。各牌号在冲击、伸长、刚度与加工性能上各有侧重。",
      overviewLabel: "材料概览",
      overview:
        "系列覆盖不同的刚韧平衡、伸长率和低温表现，各牌号均有中文详情和关键数据；技术文件与样品按项目确认。",
    },
    navigation: {
      aria: "高抗冲 POM 页面分区导航",
      title: "高抗冲 POM",
    ...
    faq: {
      ...
      items: [
        {
          question: "高抗冲 POM 面向哪些零件？",
          answer:
            "主要面向冲击敏感、装配受力或低温使用的功能注塑件，覆盖汽车、电气、卫浴和工业设备中的卡扣、壳体及机构零件。",
        },
        {
          question: "高抗冲 POM 提供哪些性能组合？",
          answer:
            "系列从均衡刚韧延伸至更高冲击、伸长率和低温表现，并提供不同的刚度、流动与热性能组合。",
        },
        {
          question: "可以获得哪些项目支持？",
          answer:
            "各牌号均可查看中文详情与关键数据，并可申请技术文件、样品及零部件验证沟通。",
        },
      ],
    },
    inquiry: {
      eyebrow: "高抗冲 POM 项目支持",
      title: "为受力零件增加韧性余量",
      body: "根据零部件冲击、温度、载荷和几何要求比较候选牌号，并提供技术数据与样品，用于材料评估和零件验证。",
