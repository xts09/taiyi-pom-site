...
test("keeps one canonical catalogue behind the 117-grade progressive browse", () => {
  ...
  assert.deepEqual(counts, { POM: 40, PA6: 33, PA66: 38, PPA: 6 });
  assert.equal(browseRecords.length, 117);
  assert.equal(new Set(browseRecords.map((record) => record.slug)).size, 117);
